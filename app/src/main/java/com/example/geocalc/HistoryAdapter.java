...
import com.example.geocalc.HistoryFragment.OnListFragmentInteractionListener;
...
public class HistoryAdapter extends
                        ...
                        HistoryAdapter.FooterViewHolder>
 {
     ...
     protected HeaderViewHolder onCreateSectionHeaderViewHolder(ViewGroup parent, int viewType) {
         View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_section_headers, parent, false);
